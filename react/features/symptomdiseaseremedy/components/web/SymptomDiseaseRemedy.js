...
/**
 * The type of the React {@code Component} props of {@link SymptomDiseaseRemedy}.
 */
type Props = {
 ...
 * @extends Component
 */
class SymptomDiseaseRemedy extends PureComponent <Props> {
    ...
    componentDidMount() {
        ...
        const url =
            'http://localhost:5000/get-symptoms';
        ...
        let data = axios({
            ...
            url: url,
            data: {
                text: "I have fever, sore throat, temperature is 100."
            },
            ...
            <div
                ...
                <div
                    ...
                    <table>
                        ...
                        <td>
                            {this.state.symptoms?
                            (this.state.symptoms.map(symptom=><tr>{symptom}</tr>))
                            :
                            null}
                        </td>
                        <td>
                            {this.state.diseases?
                            (this.state.diseases.map(disease=><tr>{disease}</tr>))
                            :
                            null}
                        </td>
                        <td>
                            {this.state.medicines?
                            (this.state.medicines.map(medicine=><tr>{medicine}</tr>))
                            :
                            null}
                        </td>
                        </tr>
...
export default translate(connect(_mapStateToProps)(SymptomDiseaseRemedy));
